    ...
    <div className={`relative min-h-dvh w-full bg-gradient-to-br from-[#040b16] via-[#02050a] to-black text-white overflow-x-clip font-sans selection:bg-blue-600 selection:text-white transition-all duration-1000 ease-out ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
      ...
      <section id="home" className="relative min-h-dvh flex items-center justify-center pt-24 md:pt-20 overflow-hidden w-full">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          <h1 className="text-4xl sm:text-6xl md:text-8xl font-black tracking-tighter leading-[1.1] mb-8 text-white">
            CONSTRUIMOS EL <br />
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a
              href="#proyectos"
              className="w-full sm:w-auto px-10 py-4 rounded-full bg-white text-black font-black text-lg hover:bg-gray-200 transition-all shadow-[0_0_40px_-10px_rgba(255,255,255,0.2)] flex items-center justify-center gap-2 group"
            >
              VER PROYECTOS
            ...
            <a
              href="#contacto"
              className="w-full sm:w-auto px-10 py-4 rounded-full border border-white/20 text-white font-bold text-lg hover:bg-white/10 transition-all text-center"
            >
              Contactar
            </a>
          </div>
      ...
      {/* --- SECCIÓN DE VALORES --- */}
      {/* Se ajustó el padding a py-16 md:py-24 para dar respiro */}
      <section ref={valoresRef} className="py-16 md:py-24 border-y border-white/10 bg-white/5 backdrop-blur-sm relative z-20 overflow-hidden w-full">
        <div className={`max-w-7xl mx-auto px-6 transition-all duration-1000 transform ${valoresVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          {/* Grid ajustado: gap vertical en móvil, divide-x solo en desktop */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-y-12 md:gap-y-0 text-center md:divide-x divide-white/10">
            <div className="px-2 md:px-4">
              <span className="block text-3xl font-black text-blue-500 mb-1">100%</span>
              <span className="text-[10px] md:text-xs text-gray-400 uppercase tracking-widest font-bold">Ingenieria aplicada</span>
            </div>
            <div className="px-2 md:px-4">
              <span className="block text-3xl font-black text-white mb-1">UI/UX</span>
              <span className="text-[10px] md:text-xs text-gray-400 uppercase tracking-widest font-bold">Diseño Centrado</span>
            </div>
            <div className="px-2 md:px-4">
              <span className="block text-3xl font-black text-white mb-1">100%</span>
              <span className="text-[10px] md:text-xs text-gray-400 uppercase tracking-widest font-bold">Código a Medida</span>
            </div>
            <div className="px-2 md:px-4">
              <span className="block text-3xl font-black text-blue-500 mb-1">24/7</span>
              <span className="text-[10px] md:text-xs text-gray-400 uppercase tracking-widest font-bold">Soporte Técnico</span>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* --- TECNOLOGÍAS --- */}
      {/* Paddings dinámicos: py-20 md:py-32 */}
      <section ref={tecnologiasRef} id="tecnologias" className="py-20 md:py-32 px-6 max-w-7xl mx-auto overflow-hidden">
        <div className={`transition-all duration-1000 transform ${tecnologiasVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}>
          ...
          <div className="text-center mb-16 relative">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[200px] md:w-64 h-[100px] md:h-32 bg-blue-600/20 blur-[60px] md:blur-[80px] -z-10"></div>
            
            <h2 className="text-sm font-bold text-blue-500 uppercase tracking-widest mb-2">Nuestro Stack</h2>
            <h3 className="text-3xl sm:text-4xl md:text-6xl font-black tracking-tight text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-[auto] md:auto-rows-[250px]">
            ...
            <div className="md:col-span-8 relative group rounded-3xl overflow-hidden bg-[#0a1120] border border-white/5 p-8 md:p-10 flex flex-col items-center text-center md:items-start md:text-left justify-between hover:border-emerald-500/50 transition-all duration-500 shadow-xl min-h-[250px]">
                ...
                <div className="relative z-10 flex flex-col items-center md:items-start">
                    ...
                    <h3 className="text-3xl md:text-4xl font-black text-white mb-2">Django & Python</h3>
                    <p className="text-gray-400 text-base md:text-lg max-w-md">Desarrollamos arquitecturas backend robustas, seguras y altamente escalables.</p>
                </div>
            </div>

            <div className="md:col-span-4 relative group rounded-3xl overflow-hidden bg-[#0a1120] border border-white/5 p-8 flex flex-col items-center justify-center text-center hover:border-blue-500/50 transition-all duration-500 shadow-xl min-h-[250px]">
            ...
            <div className="md:col-span-4 relative group rounded-3xl overflow-hidden bg-[#0a1120] border border-white/5 p-8 flex flex-col items-center justify-center text-center hover:border-cyan-500/50 transition-all duration-500 shadow-xl min-h-[250px]">
            ...
            <div className="md:col-span-8 relative group rounded-3xl overflow-hidden bg-white/5 border border-white/10 p-8 md:p-10 flex flex-col md:flex-row items-center md:items-start md:justify-between hover:bg-white/10 transition-all duration-500 shadow-xl min-h-[250px]">
                <div className="relative z-10 mb-8 md:mb-0 text-center md:text-left">
                    <h3 className="text-3xl md:text-4xl font-black text-white mb-4">Next.js & React</h3>
                    <p className="text-gray-400 text-base md:text-lg max-w-sm mx-auto md:mx-0">Interfaces de usuario dinámicas, renderizado híbrido y la mejor experiencia de navegación.</p>
                </div>
                <div className="w-24 h-24 md:w-32 md:h-32 bg-black/50 rounded-[2rem] border border-white/10 flex items-center justify-center text-white group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 shadow-2xl shrink-0">
                    <svg className="w-12 h-12 md:w-16 md:h-16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" /></svg>
                </div>
            </div>
      ...
      {/* --- PROYECTOS --- */}
      <section ref={proyectosRef} id="proyectos" className="py-20 md:py-32 bg-white/5 border-y border-white/5 overflow-hidden">
        <div className={`max-w-7xl mx-auto px-6 transition-all duration-1000 ${proyectosVisible ? 'opacity-100' : 'opacity-0'}`}>
            <div className="flex flex-col items-center md:items-start mb-12 md:mb-16 text-center md:text-left">
              <div>
                <h2 className="text-4xl md:text-5xl font-black text-white tracking-tight">NUESTROS TRABAJOS</h2>
                <p className="text-gray-400 mt-2 text-base md:text-lg">Soluciones reales desarrolladas por nuestro equipo.</p>
              </div>
            </div>
      ...
      {/* --- CONTACTO --- */}
      <section ref={contactoRef} id="contacto" className="py-20 md:py-32 px-6 text-center relative overflow-hidden w-full">
         <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] md:w-[800px] h-[300px] md:h-[800px] bg-gradient-to-tr from-blue-600/10 to-transparent rounded-full blur-[80px] md:blur-[150px] pointer-events-none"></div>
         ...
         <div className={`relative z-10 max-w-4xl mx-auto transition-all duration-1000 ${contactoVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
            <span className="inline-block py-1 px-3 rounded-full bg-white/10 text-white text-[10px] md:text-xs font-bold tracking-widest uppercase mb-6 border border-white/20">
              Contacto Directo
            </span>
            <h2 className="text-4xl sm:text-5xl md:text-8xl font-black mb-8 leading-[1.1] md:leading-[0.9] text-white">
               HAGAMOS REALIDAD <br className="hidden md:block"/> <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-white">TU PROYECTO.</span>
            </h2>
            <p className="text-base md:text-xl text-gray-400 mb-12 md:mb-16 max-w-2xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-2xl mx-auto">
              <a 
                ...
                className="group bg-white/5 border border-white/10 hover:bg-[#25D366]/20 hover:border-[#25D366]/50 text-white p-6 md:p-8 rounded-[2rem] flex flex-col items-center justify-center transition-all duration-300 hover:-translate-y-2 shadow-lg"
              >
                ...
                <span className="text-2xl md:text-3xl font-black mb-1 md:mb-2">WhatsApp</span>
                <span className="text-gray-400 font-medium text-[10px] md:text-sm uppercase tracking-widest">Respuesta rápida</span>
              </a>
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="group bg-white/5 border border-white/10 hover:bg-purple-500/20 hover:border-purple-500/50 text-white p-6 md:p-8 rounded-[2rem] flex flex-col items-center justify-center transition-all duration-300 hover:-translate-y-2 shadow-lg"
              >
                ...
                <span className="text-2xl md:text-3xl font-black mb-1 md:mb-2">Instagram</span>
                <span className="text-gray-400 font-medium text-[10px] md:text-sm uppercase tracking-widest">Sigue nuestro trabajo</span>
              </a>
            </div>
         </div>
      </section>
      ...
      {/* --- FOOTER --- */}
      <footer className="bg-[#09090b]/80 border-t border-white/5 pt-12 md:pt-16 pb-8 relative overflow-hidden w-full">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full md:w-3/4 h-24 bg-blue-600/5 blur-[100px] pointer-events-none"></div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-8 mb-12 text-center md:text-left">
            ...
            <div className="md:col-span-4 flex flex-col items-center md:items-start gap-4">
              ...
              <p className="text-sm text-gray-400 max-w-xs font-medium leading-relaxed mt-2 mx-auto md:mx-0">
